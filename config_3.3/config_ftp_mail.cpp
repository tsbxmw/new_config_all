...
int config_ftp_mail()
{
	...
	localfile[8]="10.63.220.2";//ftp ip add
	localfile[9]="mw1101";//user name default
	localfile[10]="mw1101";//password
	localfile[11]="..\\Config_upload\\";//config upload dir 
	localfile[12]="del ";//delete
	localfile[13]="\\CI_version\\config_files";//config files path on the ftp server 
	localfile[14]="M_P809V50*";// config files pre_name
	...
	{
		cout<<"<-- open the ini to get config -->"<<endl;
